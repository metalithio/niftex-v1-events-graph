...
export class ShardRegistry extends ethereum.SmartContract {
  static bind(address: Address): ShardRegistry {
    return new ShardRegistry("ShardRegistry", address);
  }
  ...
  shotgunDisabled(): boolean {
    let result = super.call("shotgunDisabled", "shotgunDisabled():(bool)", []);

    return result[0].toBoolean();
  }

  try_shotgunDisabled(): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "shotgunDisabled",
      "shotgunDisabled():(bool)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class ConstructorCall__Inputs {
  ...
  get shardGovernorAddress(): Address {
...
export class LockShardsAndClaimCall extends ethereum.Call {
  get inputs(): LockShardsAndClaimCall__Inputs {
    return new LockShardsAndClaimCall__Inputs(this);
  }

  get outputs(): LockShardsAndClaimCall__Outputs {
    return new LockShardsAndClaimCall__Outputs(this);
  }
}

export class LockShardsAndClaimCall__Inputs {
  _call: LockShardsAndClaimCall;

  constructor(call: LockShardsAndClaimCall) {
    this._call = call;
  }
}

export class LockShardsAndClaimCall__Outputs {
  _call: LockShardsAndClaimCall;
...
export class BurnAndCollectEtherCall extends ethereum.Call {
  get inputs(): BurnAndCollectEtherCall__Inputs {
    return new BurnAndCollectEtherCall__Inputs(this);
  }

  get outputs(): BurnAndCollectEtherCall__Outputs {
    return new BurnAndCollectEtherCall__Outputs(this);
  }
}

export class BurnAndCollectEtherCall__Inputs {
  _call: BurnAndCollectEtherCall;

  constructor(call: BurnAndCollectEtherCall) {
    this._call = call;
  }

  get shotgunClause(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class BurnAndCollectEtherCall__Outputs {
  _call: BurnAndCollectEtherCall;
